...
class CPBLProxy
    ...
    def team_players(team, year, kind)
    ...
    def personal_fielding_detail(id)
        translate_stats(
    ...
    def pitcher_stats_by_team_year(team, year)
        translate_stats_pair(
